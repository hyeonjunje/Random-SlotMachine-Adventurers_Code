...
public class ExchangeTwoSlotMachineKeywordsEffect : Effect, ISelectionResolver
{
    ...
    public override GameAction GetGameAction(List<CharacterView> targets, CharacterView caster)
    {
        ...
        slotMachineKeywords.Add(SlotMachineSystem.Instance.GetSlotMachineResultKeyword(SelectionResolver.SelectedIndex[1]));
